...
// Debounce de la recherche pour éviter de re-filtrer à chaque frappe
useEffect(() => {
...
// Filtrer les produits par catégorie et recherche (mémoïsé : ne recalcule que si nécessaire)
...
className={`
flex items-center gap-1.5 px-3 py-2 rounded-lg font-medium whitespace-nowrap transition-colors
...
<img
src={category.image.startsWith('http') ? category.image : `${import.meta.env.VITE_API_URL || 'http://127.0.0.1:3010'}${category.image}`}
alt=""
...
<div className="text-center">
<Search size={56} strokeWidth={1.2} className="mx-auto mb-4 text-gray-300" />
