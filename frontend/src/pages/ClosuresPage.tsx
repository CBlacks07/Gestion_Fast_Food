...
<Archive size={56} strokeWidth={1.2} className="mx-auto mb-4 text-gray-300" />
...
<button
onClick={() => setShowCreateModal(true)}
className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors flex items-center gap-2 mx-auto"
>
<Plus size={16} />
Créer une clôture
</button>
...
Vous avez déjà clôturé cette journée
</p>
)}
</div>
